#!/usr/bin/env python3
"""
Claude Code Context Monitor - Enhanced with Contextual Metadata
...
NEW FEATURES IN v2:
- Git branch detection (automatically captured)
- Task description (from env var, file marker, or git commit)
- Agent name detection (for subagent sessions)
