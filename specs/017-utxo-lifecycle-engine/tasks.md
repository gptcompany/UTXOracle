...
- [ ] T002 [P] Create `scripts/metrics/utxo_lifecycle.py` with docstring (alpha-evolve pending)
- [x] T003 [P] Create `scripts/metrics/realized_metrics.py` with docstring
- [ ] T004 [P] Create `scripts/metrics/hodl_waves.py` with docstring (alpha-evolve pending)
...
- [ ] T015a [P] Test `test_utxo_save_and_load()` in `tests/test_utxo_lifecycle.py`
- [ ] T015b [P] Test `test_utxo_index_lookup_performance()` in `tests/test_utxo_lifecycle.py`
- [ ] T015c [P] Test `test_utxo_pruning_removes_old_spent()` in `tests/test_utxo_lifecycle.py`
...
- [ ] T018a [P] [EC] Test `test_unknown_creation_price_fallback()` - mempool.space fallback
- [ ] T018b [P] [EC] Test `test_coinbase_utxo_handling()` - is_coinbase=True, subsidy value
- [ ] T018c [P] [EC] Test `test_reorg_invalidation()` - reorg_invalidated=True flow
- [ ] T018d [P] [EC] Test `test_storage_limit_exceeded_triggers_prune()` - retention enforcement
...
- [ ] T021 [E] [US1] Implement `process_block_outputs()` in `scripts/metrics/utxo_lifecycle.py`
...
- [ ] T029 [E] [US2] Implement `process_block_inputs()` in `scripts/metrics/utxo_lifecycle.py`
- [ ] T030 [E] [US2] Implement `process_block_utxos()` combining inputs/outputs
...
- [ ] T061a [US6] Integrate lifecycle tracking into `scripts/daily_analysis.py`
